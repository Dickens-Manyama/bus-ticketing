...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    /**
     * @var string Plain password for user creation
     */
    public $password;

    /**
     * @var string Confirm password for user creation
     */
    ...
    public function scenarios()
    {
        ...
        $scenarios['noRoleChange'] = $scenarios[self::SCENARIO_DEFAULT];
        unset($scenarios['noRoleChange']['role']);
        return $scenarios;
    }
